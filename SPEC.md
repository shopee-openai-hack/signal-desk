...
After A successfully persists and extracts a new Signal, the application calls B once:
...
- A dispatches each newly created Signal exactly once in replay order.
